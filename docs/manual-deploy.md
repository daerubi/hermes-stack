...
> اگر به هر دلیلی نمی‌خواهی از [ویزارد وب](https://daerubi.github.io/hermes-stack/deploy.html) استفاده کنی، همین راهنما کل مسیر را قدم‌به‌قدم پوشش می‌دهد. نتیجه‌ی نهایی هر دو راه یکسان است.
